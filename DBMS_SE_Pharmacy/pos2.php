...
<link rel="stylesheet" type="text/css" href="nav2.css?v=1">
<link rel="stylesheet" type="text/css" href="form3.css?v=3">
<link rel="stylesheet" type="text/css" href="table2.css?v=2">
<title>
New Sales
</title>
</head>
...
<body>
		...
		<a href="adminmainpage.html">Dashboard</a>
			...
			<div class="dropdown-container">
				...
				<a href="salesreport.php">Transcation - Reports</a>
			</div>
	</div>
	...
	?>
		...
		<form method=post>
		<a name='pos1' href="pos1.php?sid=<?php echo $sid; ?>" 
   style="background-color: #0d7377; color: #32e0c4; padding: 10px 24px; text-align: center; 
          text-decoration: none; display: inline-block; margin: 4px 2px; cursor: pointer; 
          font-weight: bold; font-family: Arial, sans-serif; transition: 0.3s;">
   Go Back to Sales Page
	...
	<?php
		...
		if(isset($_POST['custadd'])) {
			...
			<tr style='background-color: #2a2a2a; color: #e0e0e0;'>
				<td>Total</td>
				<td>" . $tot . "</td>
			</tr>
		</table>";
